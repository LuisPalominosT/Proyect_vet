...
Fictional veterinary website with various front-end integrations.
...
A website with various front-end integrations that enhance user experience and functionality. These integrations include Google Maps for locating the veterinary clinic, Calendly for scheduling consultation appointments, and Getform for sending inquiries via email
...
- **Libraries and Frameworks**:
  ...
  [![Vite Badge][vite-badge]][vite-url]
...
- **Tools and Platforms**:
  ...
  [![Google Maps Badge][google-maps-badge]][google-maps-url]
...
1. Clone the repo
   ...
   ```sh
   git clone https://github.com/LuisPalominosT/Proyect_vet.git
   ```
...
After succesfull installation, you will be able to check the WebApp in any browser by visiting the following URL address: [localhost:5137](http://localhost:5137/)
...
[google-maps-url]:https://www.npmjs.com/package/google-maps
